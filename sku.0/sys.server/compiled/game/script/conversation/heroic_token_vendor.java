...
public class heroic_token_vendor extends script.base_script
{
    ...
    public void heroic_token_vendor_action_showTokenVendorUI(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("heroic_token_vendor"))
        {
            return SCRIPT_CONTINUE;
        }
