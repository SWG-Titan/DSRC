...
public class imperial_title_grant extends base_script
{
    ...
    public boolean imperial_title_grant_condition_isImperialPlayer(obj_id player, obj_id npc) throws InterruptedException
    {
        return factions.isImperial(player);
    }
    public boolean imperial_title_grant_condition_isRebelPlayer(obj_id player, obj_id npc) throws InterruptedException
    {
        return factions.isRebel(player);
    }
    public boolean imperial_title_grant_condition_hasMillionCredits(obj_id player, obj_id npc) throws InterruptedException
    {
        return money.hasFunds(player, money.MT_TOTAL, money.MILLION);
    }
    public boolean imperial_title_grant_condition_hasTitle(obj_id player, obj_id npc) throws InterruptedException
    {
        return hasCompletedCollectionSlot(player, "imp_million_title");
    }
    public void imperial_title_grant_action_grantTitle(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public int imperial_title_grant_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int imperial_title_grant_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int imperial_title_grant_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int imperial_title_grant_handleBranch6(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("imperial_title_grant"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
