...
// ----------------------------------------------------------------------
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        //-- [NOTE]
        if (wendle_bar_condition__defaultCondition(player, self))
        {
            doAnimationAction(player, "celebrate");
            ...
            if (hasResponse)
            {
                ...
                npcStartConversation(player, self, "wendle_bar", message, responses);
            }
            else
            {
...
// ----------------------------------------------------------------------
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        if (branchId == 1 && wendle_bar_handleBranch1(player, self, response) == SCRIPT_CONTINUE)
            return SCRIPT_CONTINUE;
