...
public class itp_hethrir_operative extends base_script
{
    ...
    public boolean itp_hethrir_operative_condition_hethrirTaskActive(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "itp_hethrir_01", "itp_hethrir_01_04");
    }
    public void itp_hethrir_operative_action_hethrirSignal(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (itp_hethrir_operative_condition_hethrirTaskActive(player, self))
        {
            itp_hethrir_operative_action_hethrirSignal(player, self);
            string_id message = new string_id(c_stringFile, "s_32");
            chat.chat(self, player, message);
            return SCRIPT_CONTINUE;
        }
        if (itp_hethrir_operative_condition__defaultCondition(player, self))
        {
