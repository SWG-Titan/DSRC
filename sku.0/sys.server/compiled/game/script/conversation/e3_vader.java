...
public class e3_vader extends script.base_script
{
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (e3_vader_condition__defaultCondition(player, self))
        {
    ...
    {
        if (!conversationId.equals("e3_vader"))
        {
            return SCRIPT_CONTINUE;
        }
        int branchId = utils.getIntScriptVar(player, "conversation.e3_vader.branchId");
        chat.chat(self, "Error:  Fell through all branches and responses for OnNpcConversationResponse.");
        utils.removeScriptVar(player, "conversation.e3_vader.branchId");
        return SCRIPT_CONTINUE;
    }
}
