...
public class tatooine_knives_parry_larit extends base_script
{
    ...
    public boolean tatooine_knives_parry_larit_condition_onJacketTask(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return questIsTaskActive(questId1, finishJacket, player);
    }
    ...
    public boolean tatooine_knives_parry_larit_condition_firstContact(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return questIsTaskActive(questId1, finishJackets, player);
    }
    public boolean tatooine_knives_parry_larit_condition_onJacketComplete(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return (questIsTaskComplete(questId1, pistolComplete, player));
    }
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (tatooine_knives_parry_larit_condition_questComplete(player, self))
        {
            doAnimationAction(self, "spit_hands");
            tatooine_knives_parry_larit_action_facePlayer(player, self);
            string_id message = new string_id(c_stringFile, "s_29");
            chat.chat(self, player, message);
            return SCRIPT_CONTINUE;
        }
        if (tatooine_knives_parry_larit_condition_onJacketComplete(player, self))
        {
            doAnimationAction(self, "applause_excited");
            tatooine_knives_parry_larit_action_signalJacketComplete(player, self);
            string_id message = new string_id(c_stringFile, "s_28");
            chat.chat(self, player, message);
            return SCRIPT_CONTINUE;
        }
        if (tatooine_knives_parry_larit_condition_onJacketTask(player, self))
        {
            tatooine_knives_parry_larit_action_facePlayer(player, self);
        ...
        if (tatooine_knives_parry_larit_condition_firstContact(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_8");
            int numberOfResponses = 0;
            boolean hasResponse = false;
            boolean hasResponse0 = false;
            if (tatooine_knives_parry_larit_condition__defaultCondition(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse0 = true;
            ...
            if (hasResponse)
            {
                ...
                npcStartConversation(player, self, "tatooine_knives_parry_larit", message, responses);
            }
            else 
            {
                chat.chat(self, player, message);
        ...
        if (tatooine_knives_parry_larit_condition_facePlayer2(player, self))
        {
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        if (branchId == 4 && tatooine_knives_parry_larit_handleBranch4(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 5 && tatooine_knives_parry_larit_handleBranch5(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
