...
public class legacy_button_jawatracks_b3p0 extends base_script
{
    ...
    public boolean legacy_button_jawatracks_b3p0_condition_onDataRetrival(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return questIsTaskActive(questId1, onBody, player) || questIsTaskActive(questId2, onBody2, player);
    }
    ...
    public boolean legacy_button_jawatracks_b3p0_condition_raidersDead(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return questIsTaskComplete(questId1, onSaved, player) || questIsTaskComplete(questId2, onSaved2, player);
    }
    public boolean legacy_button_jawatracks_b3p0_condition_onRaiders(obj_id player, obj_id npc) throws InterruptedException
    {
        ...
        return questIsTaskActive(questId1, onSaved, player) || questIsTaskActive(questId2, onSaved2, player);
    }
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (legacy_button_jawatracks_b3p0_condition_questTracks3Complete(player, self))
        {
            doAnimationAction(self, "greet");
            legacy_button_jawatracks_b3p0_action_facePlayer(player, self);
            string_id message = new string_id(c_stringFile, "s_101");
            int numberOfResponses = 0;
            boolean hasResponse = false;
            boolean hasResponse0 = false;
            if (legacy_button_jawatracks_b3p0_condition__defaultCondition(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse0 = true;
            ...
            if (hasResponse)
            {
                ...
                npcStartConversation(player, self, "legacy_button_jawatracks_b3p0", message, responses);
            }
            else 
            {
        ...
        if (legacy_button_jawatracks_b3p0_condition_onDataRetrival(player, self))
        {
        ...
        if (legacy_button_jawatracks_b3p0_condition_keysBack(player, self))
        {
        ...
        if (legacy_button_jawatracks_b3p0_condition_onRaiders(player, self))
        {
        ...
        if (legacy_button_jawatracks_b3p0_condition_onsaveJawas(player, self))
        {
            legacy_button_jawatracks_b3p0_action_facePlayer(player, self);
        ...
        if (legacy_button_jawatracks_b3p0_condition_raidersDead(player, self))
        {
            doAnimationAction(self, "gesticulate_wildly");
            legacy_button_jawatracks_b3p0_action_signalCounterattack(player, self);
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        if (branchId == 1 && legacy_button_jawatracks_b3p0_handleBranch1(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 3 && legacy_button_jawatracks_b3p0_handleBranch3(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 6 && legacy_button_jawatracks_b3p0_handleBranch6(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 7 && legacy_button_jawatracks_b3p0_handleBranch7(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 10 && legacy_button_jawatracks_b3p0_handleBranch10(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 11 && legacy_button_jawatracks_b3p0_handleBranch11(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 13 && legacy_button_jawatracks_b3p0_handleBranch13(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 14 && legacy_button_jawatracks_b3p0_handleBranch14(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 16 && legacy_button_jawatracks_b3p0_handleBranch16(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 17 && legacy_button_jawatracks_b3p0_handleBranch17(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
