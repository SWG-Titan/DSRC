...
public class nova_orion_vendor extends script.base_script
{
    ...
    public boolean nova_orion_vendor_condition_isANovaOrionEmployee(obj_id player, obj_id npc) throws InterruptedException
    {
        return hasCompletedCollectionSlot(player, "nova_orion_rank_01");
    }
    public void nova_orion_vendor_action_showResourceVendorUI(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (nova_orion_vendor_condition_isANovaOrionEmployee(player, self))
        {
            nova_orion_vendor_action_showResourceVendorUI(player, self);
        ...
        if (nova_orion_vendor_condition__defaultCondition(player, self))
        {
    ...
    {
        if (!conversationId.equals("nova_orion_vendor"))
        {
            return SCRIPT_CONTINUE;
        }
