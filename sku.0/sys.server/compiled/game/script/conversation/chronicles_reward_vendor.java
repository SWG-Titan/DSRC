...
public class chronicles_reward_vendor extends script.base_script
{
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (chronicles_reward_vendor_condition__defaultCondition(player, self))
        {
            chronicles_reward_vendor_action_showResourceVendorUI(player, self);
    ...
    {
        if (!conversationId.equals("chronicles_reward_vendor"))
        {
            return SCRIPT_CONTINUE;
        }
