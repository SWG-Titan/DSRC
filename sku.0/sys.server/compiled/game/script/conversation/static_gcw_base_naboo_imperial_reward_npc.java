...
public class static_gcw_base_naboo_imperial_reward_npc extends base_script
{
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        ...
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_5(player, npc))
            {
                string_id message = new string_id(c_stringFile, "s_31");
                int numberOfResponses = 0;
                boolean hasResponse = false;
                boolean hasResponse0 = false;
                if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
                {
                    ++numberOfResponses;
                    hasResponse = true;
                    hasResponse0 = true;
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 3);
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_4(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 5);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_3(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 7);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_2(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 9);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 11);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (response.equals("s_25"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_5(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 13);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_4(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 15);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_3(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 17);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_2(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 19);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 21);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (response.equals("s_44"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_5(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 23);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_4(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 25);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 27);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (response.equals("s_102"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_5(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 29);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_4(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 31);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 33);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (response.equals("s_124"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_5(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 35);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_4(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 37);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 39);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (response.equals("s_146"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_5(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 41);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_4(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 43);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_3(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 45);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_2(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 47);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 49);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (response.equals("s_168"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_5(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 51);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_4(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 53);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_3(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 55);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_2(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 57);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 59);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (response.equals("s_190"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_5(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 61);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_4(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 63);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                ...
                if (hasResponse)
                {
                    ...
                    utils.setScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId", 65);
                    npcSpeak(player, message);
                    npcSetConversationResponses(player, responses);
                }
                else 
        ...
        if (response.equals("s_212"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantRallyBanner(player, npc);
        ...
        if (response.equals("s_247"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_advanceRewardPhase(player, npc);
        ...
        if (response.equals("s_249"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_regressRewardPhase(player, npc);
        ...
        if (response.equals("s_254"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_reportRewardPhase(player, npc);
        ...
        if (response.equals("s_225"))
        {
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                ...
                pp.actor.set(player);
                pp.target.set(npc);
                pp.other.set(static_gcw_base_naboo_imperial_reward_npc_tokenTO_timeToNext(player, npc));
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_50"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantHealthPack5(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch5(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_52"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantHealthPack4(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch7(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_54"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantHealthPack3(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch9(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_56"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantHealthPack2(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch11(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_58"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantHealthPack1(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch13(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_64"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantActionPack5(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch15(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_66"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantActionPack4(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch17(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_68"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantActionPack3(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch19(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_70"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantActionPack2(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch21(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_277"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantActionPack1(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch23(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_86"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantDamageAbsorb3(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch25(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_92"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantDamageAbsorb2(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch27(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_98"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantDamageAbsorb1(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch29(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_106"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantDamageBoost3(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch31(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_112"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantDamageBoost2(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch33(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_118"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantDamageBoost1(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch35(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_128"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantDamageShield3(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch37(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_134"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantDamageShield2(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch39(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_140"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantDamageShield1(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch41(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_263"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantReactiveHeal5(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch43(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_261"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantReactiveHeal4(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch45(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_150"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantReactiveHeal3(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch47(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_156"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantReactiveHeal2(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch49(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_162"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantReactiveHeal1(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch51(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_268"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantReactiveAction5(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch53(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_266"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantReactiveAction4(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch55(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_172"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantReactiveAction3(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch57(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_178"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantReactiveAction2(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch59(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_184"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantReactiveAction1(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch61(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_194"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantLastChance3(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch63(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_200"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantLastChance2(player, npc);
    ...
    public int static_gcw_base_naboo_imperial_reward_npc_handleBranch65(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
        if (response.equals("s_206"))
        {
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, npc))
            {
                static_gcw_base_naboo_imperial_reward_npc_action_grantLastChance1(player, npc);
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (!static_gcw_base_naboo_imperial_reward_npc_condition_inControlOfBase(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_15");
            chat.chat(self, player, message);
            return SCRIPT_CONTINUE;
        }
        if (static_gcw_base_naboo_imperial_reward_npc_condition_playerImperial(player, self))
        {
            ...
            boolean hasResponse = false;
            boolean hasResponse0 = false;
            if (static_gcw_base_naboo_imperial_reward_npc_condition__defaultCondition(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse0 = true;
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_3(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse2 = true;
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_reward_phase_5(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse8 = true;
            ...
            if (static_gcw_base_naboo_imperial_reward_npc_condition_isGodPlayer(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse14 = true;
            ...
            if (hasResponse)
            {
                ...
                npcStartConversation(player, self, "static_gcw_base_naboo_imperial_reward_npc", message, responses);
            }
            else 
            {
                chat.chat(self, player, message);
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        int branchId = utils.getIntScriptVar(player, "conversation.static_gcw_base_naboo_imperial_reward_npc.branchId");
        if (branchId == 2 && static_gcw_base_naboo_imperial_reward_npc_handleBranch2(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 3 && static_gcw_base_naboo_imperial_reward_npc_handleBranch3(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 5 && static_gcw_base_naboo_imperial_reward_npc_handleBranch5(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 7 && static_gcw_base_naboo_imperial_reward_npc_handleBranch7(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 9 && static_gcw_base_naboo_imperial_reward_npc_handleBranch9(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 11 && static_gcw_base_naboo_imperial_reward_npc_handleBranch11(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 13 && static_gcw_base_naboo_imperial_reward_npc_handleBranch13(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 15 && static_gcw_base_naboo_imperial_reward_npc_handleBranch15(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 17 && static_gcw_base_naboo_imperial_reward_npc_handleBranch17(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 19 && static_gcw_base_naboo_imperial_reward_npc_handleBranch19(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 21 && static_gcw_base_naboo_imperial_reward_npc_handleBranch21(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 23 && static_gcw_base_naboo_imperial_reward_npc_handleBranch23(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 25 && static_gcw_base_naboo_imperial_reward_npc_handleBranch25(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 27 && static_gcw_base_naboo_imperial_reward_npc_handleBranch27(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 29 && static_gcw_base_naboo_imperial_reward_npc_handleBranch29(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 31 && static_gcw_base_naboo_imperial_reward_npc_handleBranch31(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 33 && static_gcw_base_naboo_imperial_reward_npc_handleBranch33(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 35 && static_gcw_base_naboo_imperial_reward_npc_handleBranch35(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 37 && static_gcw_base_naboo_imperial_reward_npc_handleBranch37(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 39 && static_gcw_base_naboo_imperial_reward_npc_handleBranch39(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 41 && static_gcw_base_naboo_imperial_reward_npc_handleBranch41(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 43 && static_gcw_base_naboo_imperial_reward_npc_handleBranch43(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 45 && static_gcw_base_naboo_imperial_reward_npc_handleBranch45(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 47 && static_gcw_base_naboo_imperial_reward_npc_handleBranch47(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 49 && static_gcw_base_naboo_imperial_reward_npc_handleBranch49(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 51 && static_gcw_base_naboo_imperial_reward_npc_handleBranch51(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 53 && static_gcw_base_naboo_imperial_reward_npc_handleBranch53(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 55 && static_gcw_base_naboo_imperial_reward_npc_handleBranch55(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 57 && static_gcw_base_naboo_imperial_reward_npc_handleBranch57(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 59 && static_gcw_base_naboo_imperial_reward_npc_handleBranch59(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 61 && static_gcw_base_naboo_imperial_reward_npc_handleBranch61(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 63 && static_gcw_base_naboo_imperial_reward_npc_handleBranch63(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 65 && static_gcw_base_naboo_imperial_reward_npc_handleBranch65(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
