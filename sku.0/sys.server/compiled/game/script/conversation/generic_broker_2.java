...
public class generic_broker_2 extends base_script
{
    public generic_broker_2()
    {
    }
    public static String c_stringFile = "conversation/generic_broker_2";
    public boolean generic_broker_2_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean generic_broker_2_condition_isNonSmuggler(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean generic_broker_2_condition_isDoingMission(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean generic_broker_2_condition_missionTierRequirement(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean generic_broker_2_condition_hasMissionFunds(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean generic_broker_2_condition_hasSomeContraband(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean generic_broker_2_condition_hasMissionContraband(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void generic_broker_2_action_startGiveQuest(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void generic_broker_2_action_givePointerQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        float underworldFaction = factions.getFactionStanding(player, "underworld");
    ...
    public void generic_broker_2_action_giveIllicitPointerQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        float underworldFaction = factions.getFactionStanding(player, "underworld");
    ...
    public int generic_broker_2_tokenDI_frontMoney(obj_id player, obj_id npc) throws InterruptedException
    {
        return (smuggler.TIER_2_GENERIC_FRONT_COST);
    }
    public int generic_broker_2_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int generic_broker_2_handleBranch6(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int generic_broker_2_handleBranch7(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int generic_broker_2_handleBranch12(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (generic_broker_2_condition_isNonSmuggler(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_4");
            chat.chat(self, player, message);
            return SCRIPT_CONTINUE;
        }
        if (generic_broker_2_condition_isDoingMission(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_6");
            chat.chat(self, player, message);
            return SCRIPT_CONTINUE;
        }
        if (!generic_broker_2_condition_missionTierRequirement(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_8");
            int numberOfResponses = 0;
            boolean hasResponse = false;
            boolean hasResponse0 = false;
            if (generic_broker_2_condition__defaultCondition(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse0 = true;
            ...
            if (hasResponse)
            {
                ...
                npcStartConversation(player, self, "generic_broker_2", message, responses);
            }
            else 
            {
                chat.chat(self, player, message);
        ...
        if (generic_broker_2_condition__defaultCondition(player, self))
        {
            ...
            if (generic_broker_2_condition_hasSomeContraband(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse2 = true;
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        if (branchId == 3 && generic_broker_2_handleBranch3(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 6 && generic_broker_2_handleBranch6(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 7 && generic_broker_2_handleBranch7(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 12 && generic_broker_2_handleBranch12(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
