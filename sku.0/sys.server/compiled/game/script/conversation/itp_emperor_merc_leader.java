...
public class itp_emperor_merc_leader extends script.base_script
{
    ...
    public boolean itp_emperor_merc_leader_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean itp_emperor_merc_leader_condition_emperorTaskActive(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "itp_emperor_01", "itp_emperor_01_01");
    }
    public boolean itp_emperor_merc_leader_condition_emperorTask02Active(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "itp_emperor_01", "itp_emperor_01_04");
    }
    public void itp_emperor_merc_leader_action_emperorSignal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "itp_emperor_01_01");
    }
    public void itp_emperor_merc_leader_action_emperor02Signal(obj_id player, obj_id npc) throws InterruptedException
    {
