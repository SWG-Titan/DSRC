...
public class tcg_vendor extends script.base_script
{
    ...
    public void tcg_vendor_action_showTokenVendorUI(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (tcg_vendor_condition__defaultCondition(player, self))
        {
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        int branchId = utils.getIntScriptVar(player, "conversation.tcg_vendor.branchId");
