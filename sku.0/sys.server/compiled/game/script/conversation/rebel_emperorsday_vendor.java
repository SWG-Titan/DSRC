...
public class rebel_emperorsday_vendor extends base_script
{
    ...
    public boolean rebel_emperorsday_vendor_condition_imperial(obj_id player, obj_id npc) throws InterruptedException
    {
        return factions.isImperial(player);
    }
    public void rebel_emperorsday_vendor_action_showTokenVendorUI(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("rebel_emperorsday_vendor"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
