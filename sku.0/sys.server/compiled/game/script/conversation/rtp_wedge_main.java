...
public class rtp_wedge_main extends script.base_script
{
    ...
    public boolean rtp_wedge_main_condition_rtp_wedge_01_active(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "rtp_wedge_01");
    }
    public boolean rtp_wedge_main_condition_rtp_wedge_01_complete(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "rtp_wedge_01", "rtp_wedge_01_03") || groundquests.hasCompletedQuest(player, "rtp_wedge_01");
    }
    public boolean rtp_wedge_main_condition_completedQualdo(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.hasCompletedQuest(player, "rtp_qualdo_01");
    }
    public boolean rtp_wedge_main_condition_notRebel(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean rtp_wedge_main_condition_rebel_isOnLeave(obj_id player, obj_id npc) throws InterruptedException
    {
        return factions.isOnLeave(player);
    }
    public void rtp_wedge_main_action_rtp_wedge_01_granted(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "rtp_wedge_01");
    }
    public void rtp_wedge_main_action_rtp_wedge_01_signal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "rtp_wedge_01_03");
    }
    public int rtp_wedge_main_handleBranch6(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("rtp_wedge_main"))
        {
            return SCRIPT_CONTINUE;
        }
