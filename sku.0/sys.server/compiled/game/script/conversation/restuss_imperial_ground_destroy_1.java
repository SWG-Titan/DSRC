...
public class restuss_imperial_ground_destroy_1 extends script.base_script
{
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (restuss_imperial_ground_destroy_1_condition_isRebelPlayer(player, self))
        {
            restuss_imperial_ground_destroy_1_action_eject(player, self);
            string_id message = new string_id(c_stringFile, "s_41");
            chat.chat(self, player, message);
            return SCRIPT_CONTINUE;
        }
        if (restuss_imperial_ground_destroy_1_condition_completedKill2(player, self))
        {
            doAnimationAction(self, "salute2");
            doAnimationAction(player, "salute2");
            restuss_imperial_ground_destroy_1_action_signalDone2(player, self);
            string_id message = new string_id(c_stringFile, "s_13");
            chat.chat(self, player, message);
            return SCRIPT_CONTINUE;
        }
        if (restuss_imperial_ground_destroy_1_condition_completedKill1(player, self))
        {
            doAnimationAction(self, "salute2");
            doAnimationAction(player, "salute2");
            restuss_imperial_ground_destroy_1_action_signalDone(player, self);
            string_id message = new string_id(c_stringFile, "s_6");
            chat.chat(self, player, message);
            return SCRIPT_CONTINUE;
        }
        if (restuss_imperial_ground_destroy_1_condition_killActive2(player, self))
        {
            doAnimationAction(self, "salute2");
            doAnimationAction(player, "salute2");
        ...
        if (restuss_imperial_ground_destroy_1_condition_killActive1(player, self))
        {
            doAnimationAction(self, "salute2");
            doAnimationAction(player, "salute2");
        ...
        if (restuss_imperial_ground_destroy_1_condition_enoughKills(player, self))
        {
            doAnimationAction(self, "salute2");
            doAnimationAction(player, "salute2");
            ...
            if (restuss_imperial_ground_destroy_1_condition__defaultCondition(player, self))
            {
                ++numberOfResponses;
                hasResponse = true;
                hasResponse0 = true;
            ...
            if (hasResponse)
            {
                ...
                npcStartConversation(player, self, "restuss_imperial_ground_destroy_1", message, responses);
            }
            else 
            {
                chat.chat(self, player, message);
        ...
        if (restuss_imperial_ground_destroy_1_condition_inPhase2(player, self))
        {
            doAnimationAction(self, "salute2");
            doAnimationAction(player, "salute2");
        ...
        if (restuss_imperial_ground_destroy_1_condition_inPhase1(player, self))
        {
            doAnimationAction(self, "salute2");
            doAnimationAction(player, "salute2");
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        if (branchId == 6 && restuss_imperial_ground_destroy_1_handleBranch6(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 9 && restuss_imperial_ground_destroy_1_handleBranch9(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
        if (branchId == 12 && restuss_imperial_ground_destroy_1_handleBranch12(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
