...
public class ep3_trandosha_orooroo_zssik_04 extends base_script
{
    ...
    public int ep3_trandosha_orooroo_zssik_04_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("ep3_trandosha_orooroo_zssik_04"))
        {
            return SCRIPT_CONTINUE;
        }
