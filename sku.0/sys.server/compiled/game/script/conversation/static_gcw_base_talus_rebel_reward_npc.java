...
public class static_gcw_base_talus_rebel_reward_npc extends script.base_script
{
    ...
    public boolean static_gcw_base_talus_rebel_reward_npc_condition_playerRebel(obj_id player, obj_id npc) throws InterruptedException
    {
        return factions.isRebel(player);
    }
    public boolean static_gcw_base_talus_rebel_reward_npc_condition_inControlOfBase(obj_id player, obj_id npc) throws InterruptedException
    {
        return gcw.getPub30StaticBaseControllingFaction(npc) == gcw.REBEL_CONTROL;
    }
    public boolean static_gcw_base_talus_rebel_reward_npc_condition_reward_phase_3(obj_id player, obj_id npc) throws InterruptedException
    {
        return gcw.getPub30StaticBaseCapturePhase(npc) >= 3;
    }
    public boolean static_gcw_base_talus_rebel_reward_npc_condition_reward_phase_4(obj_id player, obj_id npc) throws InterruptedException
    {
        return gcw.getPub30StaticBaseCapturePhase(npc) >= 4;
    }
    public boolean static_gcw_base_talus_rebel_reward_npc_condition_isGodPlayer(obj_id player, obj_id npc) throws InterruptedException
    {
        return isGod(player);
    }
    public boolean static_gcw_base_talus_rebel_reward_npc_condition_reward_phase_5(obj_id player, obj_id npc) throws InterruptedException
    {
        return gcw.getPub30StaticBaseCapturePhase(npc) == 5;
    }
    public boolean static_gcw_base_talus_rebel_reward_npc_condition_reward_phase_2(obj_id player, obj_id npc) throws InterruptedException
    {
        return gcw.getPub30StaticBaseCapturePhase(npc) >= 2;
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantHealthPack1(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_health_a_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantHealthPack2(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_health_b_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantHealthPack3(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_health_c_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantHealthPack4(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_health_d_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantHealthPack5(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_health_e_04_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantActionPack1(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_action_a_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantActionPack2(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_action_b_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantActionPack3(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_action_c_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantActionPack4(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_action_d_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantActionPack5(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_action_e_04_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantDamageAbsorb1(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_damage_absorb_a_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantDamageAbsorb2(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_damage_absorb_b_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantDamageAbsorb3(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_damage_absorb_c_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantDamageAbsorb4(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_damage_absorb_d_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantDamageAbsorb5(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_damage_absorb_e_04_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantDamageBoost1(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_damage_booster_a_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantDamageBoost2(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_damage_booster_b_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantDamageBoost3(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_damage_booster_c_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantDamageShield1(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_damage_shield_a_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantDamageShield2(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_damage_shield_b_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantDamageShield3(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_damage_shield_c_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantReactiveHeal1(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_reactive_heal_a_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantReactiveHeal2(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_reactive_heal_b_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantReactiveHeal3(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_reactive_heal_c_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantReactiveAction1(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_reactive_action_a_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantReactiveAction2(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_reactive_action_b_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantReactiveAction3(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_reactive_action_c_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantLastChance1(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_reactive_critical_heal_a_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantLastChance2(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_reactive_critical_heal_b_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantLastChance3(obj_id player, obj_id npc) throws InterruptedException
    {
        static_item.createNewItemFunction("item_gcw_base_reactive_critical_heal_c_03_01", player);
    }
    public void static_gcw_base_talus_rebel_reward_npc_action_grantRallyBanner(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public int static_gcw_base_talus_rebel_reward_npc_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("static_gcw_base_talus_rebel_reward_npc"))
        {
            return SCRIPT_CONTINUE;
        }
        obj_id npc = self;
