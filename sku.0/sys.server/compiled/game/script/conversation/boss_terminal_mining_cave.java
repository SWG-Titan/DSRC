...
public class boss_terminal_mining_cave extends base_script
{
    ...
    public boolean boss_terminal_mining_cave_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean boss_terminal_mining_cave_condition_hasQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "outbreak_undead_rancor_boss_fight");
    }
    public boolean boss_terminal_mining_cave_condition_hasGroup(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean boss_terminal_mining_cave_condition_hasBossTask(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean boss_terminal_mining_cave_condition_hasQuestAndGroup(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public boolean boss_terminal_mining_cave_condition_wave_event_active(obj_id player, obj_id npc) throws InterruptedException
    {
        int wave = utils.getIntScriptVar(npc, "waveEventCurrentWave");
        return wave > 0;
    }
    public void boss_terminal_mining_cave_action_startEvent(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary dict = new dictionary();
        dict.put("player", player);
        messageTo(npc, "waveEventControllerNPCStart", dict, 0, false);
    }
    public void boss_terminal_mining_cave_action_foundTerminal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "hasFoundNymsGirlfriend");
    }
    public void boss_terminal_mining_cave_action_unauthorizedUse(obj_id player, obj_id npc) throws InterruptedException
    {
        string_id barkString = new string_id("theme_park_nym/messages", "terminal_unauthorized");
        chat.chat(npc, barkString);
    }
    public void boss_terminal_mining_cave_action_busyWithOtherPlayer(obj_id player, obj_id npc) throws InterruptedException
    {
        string_id barkString = new string_id("theme_park_nym/messages", "terminal_busy");
        chat.chat(npc, barkString);
    }
    public int boss_terminal_mining_cave_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
