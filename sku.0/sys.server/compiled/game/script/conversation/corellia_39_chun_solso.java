...
public class corellia_39_chun_solso extends script.base_script
{
    ...
    public boolean corellia_39_chun_solso_condition_taskOneActive(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "corellia_39_sidequest_08");
    }
    public boolean corellia_39_chun_solso_condition_taskOneComplete(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void corellia_39_chun_solso_action_questGranted(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "corellia_39_sidequest_08");
    }
    public void corellia_39_chun_solso_action_taskOneCompletedSignal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "corellia_39_sidequest_08_02");
    }
    public int corellia_39_chun_solso_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) throws InterruptedException
    {
        ...
        if (corellia_39_chun_solso_condition_taskOneComplete(player, self))
        {
            corellia_39_chun_solso_action_taskOneCompletedSignal(player, self);
            string_id message = new string_id(c_stringFile, "s_48");
            chat.chat(self, player, message);
            return SCRIPT_CONTINUE;
        }
        if (corellia_39_chun_solso_condition_taskOneActive(player, self))
        {
            string_id message = new string_id(c_stringFile, "s_49");
            chat.chat(self, player, message);
            return SCRIPT_CONTINUE;
        }
        if (corellia_39_chun_solso_condition__defaultCondition(player, self))
        {
            ...
            if (hasResponse)
            {
                ...
                npcStartConversation(player, self, "corellia_39_chun_solso", message, responses);
            }
            else 
            {
                chat.chat(self, player, message);
    ...
    public int OnNpcConversationResponse(obj_id self, String conversationId, obj_id player, string_id response) throws InterruptedException
    {
        ...
        if (branchId == 3 && corellia_39_chun_solso_handleBranch3(player, self, response) == SCRIPT_CONTINUE)
        {
            return SCRIPT_CONTINUE;
        }
