...
public class corellia_murmurs_1_moril extends base_script
{
    ...
    public static String c_stringFile = "conversation/corellia_murmurs_1_moril";
    public boolean corellia_murmurs_1_moril_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean corellia_murmurs_1_moril_condition_talktoMoril(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "coronet_murmurs_1_smuggler", "talktomoril");
    }
    public boolean corellia_murmurs_1_moril_condition_finishedwithMoril(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.hasCompletedTask(player, "coronet_murmurs_1_smuggler", "talktomoril");
    }
    public void corellia_murmurs_1_moril_action_signalMoril(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "coronet_murmurs_moril");
    }
    public int corellia_murmurs_1_moril_handleBranch2(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int corellia_murmurs_1_moril_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    public int corellia_murmurs_1_moril_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("corellia_murmurs_1_moril"))
        {
            return SCRIPT_CONTINUE;
        }
