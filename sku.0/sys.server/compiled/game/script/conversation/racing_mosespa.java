...
public class racing_mosespa extends base_script
{
    ...
    public boolean racing_mosespa_condition_hasRaced(obj_id player, obj_id npc) throws InterruptedException
    {
        return (hasObjVar(player, "racing.bestTime.mosespa"));
    }
    public boolean racing_mosespa_condition_isRacing(obj_id player, obj_id npc) throws InterruptedException
    {
        return (getIntObjVar(player, "racing.mosespa.isRacing") == 1);
    }
    public boolean racing_mosespa_condition_hasLastTime(obj_id player, obj_id npc) throws InterruptedException
    {
        return (hasObjVar(player, "racing.lastTime.mosespa"));
    }
    public void racing_mosespa_action_registerPersonalBest(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void racing_mosespa_action_startRace(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_mosespa_action_displayCurrentLeader(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_mosespa_action_whatsMyBestTime(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_mosespa_action_showBestTime(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_mosespa_action_erasePersonalBest(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_mosespa_action_abortRace(obj_id player, obj_id npc) throws InterruptedException
    {
        dictionary params = new dictionary();
        params.put("player", player);
    ...
    {
        if (!conversationId.equals("racing_mosespa"))
        {
            return SCRIPT_CONTINUE;
        }
