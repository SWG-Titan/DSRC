...
public class corellia_38_olivia_bain extends base_script
{
    public corellia_38_olivia_bain()
    {
    }
    public static String c_stringFile = "conversation/corellia_38_olivia_bain";
    public boolean corellia_38_olivia_bain_condition__defaultCondition(obj_id player, obj_id npc) throws InterruptedException
    {
        return true;
    }
    public boolean corellia_38_olivia_bain_condition_questOneActive(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "corellia_38_sidequest_05");
    }
    public boolean corellia_38_olivia_bain_condition_taskOneComplete(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void corellia_38_olivia_bain_action_questGranted(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.grantQuest(player, "corellia_38_sidequest_05");
    }
    public void corellia_38_olivia_bain_action_taskOneCompletedSignal(obj_id player, obj_id npc) throws InterruptedException
    {
        groundquests.sendSignal(player, "corellia_38_sidequest_05_04");
    }
    public int corellia_38_olivia_bain_handleBranch3(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
