...
public class e3_corvette extends base_script
{
    ...
    public void e3_corvette_action_boardCorvette(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public int e3_corvette_handleBranch1(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
