...
public class heroic_sd_intro_rebel extends script.base_script
{
    ...
    public boolean heroic_sd_intro_rebel_condition_notRebelFaction(obj_id player, obj_id npc) throws InterruptedException
    {
        return !factions.isRebel(player);
    }
    public boolean heroic_sd_intro_rebel_condition_onQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isQuestActive(player, "star_destroyer_intro_rebel");
    }
    public boolean heroic_sd_intro_rebel_condition_returningQuest(obj_id player, obj_id npc) throws InterruptedException
    {
        return groundquests.isTaskActive(player, "star_destroyer_intro_rebel", "star_destroyer_intro_07") || groundquests.hasCompletedQuest(player, "star_destroyer_intro_rebel");
    }
    public void heroic_sd_intro_rebel_action_grantIntroQuest(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public void heroic_sd_intro_rebel_action_sendIntroSignal(obj_id player, obj_id npc) throws InterruptedException
    {
    ...
    public int heroic_sd_intro_rebel_handleBranch4(obj_id player, obj_id npc, string_id response) throws InterruptedException
    {
    ...
    {
        if (!conversationId.equals("heroic_sd_intro_rebel"))
        {
            return SCRIPT_CONTINUE;
        }
