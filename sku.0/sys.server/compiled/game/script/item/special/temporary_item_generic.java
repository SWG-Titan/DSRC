...
public class temporary_item_generic extends script.base_script
{
    public temporary_item_generic()
    {
    }

    public static final float LIFESPAN = 14400f;
