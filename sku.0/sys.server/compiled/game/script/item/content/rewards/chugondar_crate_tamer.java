...
public class chugondar_crate_tamer extends base_script
{
    //3f 3c 3e
    ...
    {
        setName(self, "Chu-Gon Dar: Master Taming Necklace Crate");
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        if (item == menu_info_types.ITEM_USE)
        {
            ...
            LOG("ethereal", "[Chu-Gon Dar]: Player " + getName(player) + " has retrieved all items from a Chu-Gon Dar: Master Taming Necklace Crate");
