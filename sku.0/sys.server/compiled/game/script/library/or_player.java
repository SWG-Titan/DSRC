...
public class or_player extends script.base_script
{
    ...
    public static void rewardGroup(obj_id group_id, String item, boolean noTrade)
    {
    ...
    public static void doWorldBossAnnounce(obj_id target, int worldboss)
    {
        ...
        switch (worldboss)
        {
            case 0:
                ...
                or_player.sendWorldBossUpdateToDiscord(target, pekoString, "Bounty Hunters' Guild", true, false, false);
            ...
            case 1:
                ...
                or_player.sendWorldBossUpdateToDiscord(target, kraytString, "Bounty Hunters' Guild", true, false, false);
            ...
            case 2:
                ...
                or_player.sendWorldBossUpdateToDiscord(target, mandoString, "Bounty Hunters' Guild", true, false, false);
            ...
            case 3:
                ...
                or_player.sendWorldBossUpdateToDiscord(target, ewokString, "Bounty Hunters' Guild", true, false, false);
            ...
            case 4:
                ...
                or_player.sendWorldBossUpdateToDiscord(target, gunganString, "Bounty Hunters' Guild", true, false, false);
            ...
            case 5:
                ...
                or_player.sendWorldBossUpdateToDiscord(target, aurraString, "Bounty Hunters' Guild", true, false, true);
            ...
            case 6:
                ...
                or_player.sendWorldBossUpdateToDiscord(target, handString, "Bounty Hunters' Guild", true, false, true);
            ...
            case 7:
                ...
                or_player.sendWorldBossUpdateToDiscord(target, droidString, "Bounty Hunters' Guild", true, false, false);
                broadcastGalaxy(droidString);
        }
    }

    public static void doWorldBossDeathMsg(obj_id target, obj_id killer)
    {
        if (isPlayer(killer))
        {
            if (group.isGrouped(killer))
            {
                ...
                or_player.sendWorldBossUpdateToDiscord(target, worldBossWinMessage, "Bounty Hunters' Guild", true, false, false);
            }
            else
            {
                String worldBossWinMessageLite = "The world boss '" + getEncodedName(target) + "' has been defeated by " + toUpper(getFirstName(killer), 0);
                or_player.sendWorldBossUpdateToDiscord(target, worldBossWinMessageLite, "Bounty Hunters' Guild", true, false, false);
            }
        }
        else
        {
    ...
    public float getConfigFloat(String configString)
    {
    ...
    public int getConfigInt(String configString)
    {
        String value = toLower(getConfigSetting("NB", configString));
        if (value == null)
        {
    ...
    public void disarmGroup(obj_id group)
    {
        obj_id[] members = getGroupMemberIds(group);
        for (obj_id member : members)
        {
    ...
    public static void disarmPlayer(obj_id player)
    {
