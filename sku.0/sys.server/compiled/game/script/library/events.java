...
public class events extends script.base_script
{
     ...
     *
     * @param eventName
     *         the name of the event (uses constants above)
    ...
    public static boolean isEventRunning(String eventName)
    {
        ...
        if (eventName.equals(FOOLS_DAY))
        {
            ...
            else
            {
                ...
                { // if fools day isn't forced, only start it on literally April 1 from 12AM to 11:59PM
