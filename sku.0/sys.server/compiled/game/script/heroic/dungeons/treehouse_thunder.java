...
public class treehouse_thunder extends script.base_script
{

    public static String SPAWN_TABLE = "datatable/theme_park/heroic/treehouse_thunder.iff";
    public static String AREA_SCENE = "adventure3";

    public treehouse_thunder()
    {
    }
    ...
    {
        setName(self, "SPAWNER | TRANDO_HEROIC");
        return SCRIPT_CONTINUE;
    }
    ...
    public static int setupSpawns(obj_id self)
    {
        ...
        for (int i = 0; i < spawnTableLength; i++)
        {
            ...
            try
            {
                ...
                setObjVar(self, "heroic.mob.childId", spawn);
