...
public final class location implements Comparable, Serializable
{
    ...
    {
        return "/wp " + area + " " + x + " " + y + " " + z + " " + color;
    }

    public String toClipboardFormat(String color, String name)
    {
        return "/wp " + area + " " + x + " " + y + " " + z + " " + color + " " + name;
    }
    public String toClipboardFormatForceY(String color, float y, String name)
    {
        return "/wp " + area + " " + x + " " + y + " " + z + " " + color + " " + name;
    }

    public String toTeleportFormat()
    {
        return "/planetwarp " + area + " " + x + " " + y + " " + z;
    }
     ...
     * Conversion function.
     *
     * @return the location as a string for pasting into tables.
     */

    public String toTabFormat(boolean includePlanet)
    {
        if (includePlanet)
        {
            return x + "f\t" + y + "f\t" + z + "f\t" + area + "\t" + cell;
        }
        else
        {
            return x + "f\t" + y + "f\t" + z + "f\t" + cell;
        }
    }
    ...
    public String toPrettyPrint() // No label
    {
        //Waypoint format: /wp PLANET X Y Z COLOR NAME
        return "```/wp " + area + " " + x + " " + y + " " + z + " " + "purple " + "Waypoint```";
    }

    public String toPrettyPrint(String label)
    {
        //Waypoint format: /wp PLANET X Y Z COLOR NAME
        return "```/wp " + area + " " + x + " " + y + " " + z + " " + "purple " + label + "```";
    }

    public String toPrettyPrint(String label, boolean round)
    {
        //Waypoint format: /wp PLANET X Y Z COLOR NAME
        return "```/wp " + area + " " + Math.round(x) + " " + Math.round(y) + " " + Math.round(z) + " " + "purple " + label + "```";
    }

    public String toLogFormat()
    {
        return "loc: " + x + ", " + y + ", " + z + " on " + area + " in cell " + cell;
    }
}    // class location
