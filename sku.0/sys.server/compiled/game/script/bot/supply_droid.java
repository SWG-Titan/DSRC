package script.bot;/*
@Origin: script.bot.supply_droid
@Author: BubbaJoeX
...
public class supply_droid extends script.base_script
{
    ...
    {
        setName(self, "Stimpack Supply Droid");
        setDescriptionString(self, "This droid will supply you with stimpacks and tactical buffs.");
