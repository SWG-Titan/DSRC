...
public class tos_emitter extends base_script
{
    public int OnAttach(obj_id self)
    {
        setName(self, "[DEVL] Client Effect Emitter");
    ...
    public int OnObjectMenuRequest(obj_id self, obj_id player, menu_info mi) throws InterruptedException
    {
        if (isGod(player))
        {
            ...
            mi.addSubMenu(dad, menu_info_types.SERVER_MENU2, new string_id("Set Emitter Effect"));
    ...
    public int handleSetEmitterEffect(obj_id self, dictionary params) throws InterruptedException
    {
        ...
        setObjVar(self, "effect", "clienteffect/" + effect);
    ...
    public String[] getClientEffects(obj_id self, String key, boolean recursive) throws InterruptedException
    {
        ...
        String directoryPath = "/home/swg/swg-main/serverdata/clienteffect";
        ...
        if (files != null)
        {
            ...
            for (File file : files)
            {
                ...
                if (file.isFile() && file.getName().toLowerCase().endsWith(".cef") && file.getName().toLowerCase().contains(key.toLowerCase()))
                {
                    String filePath = file.getPath().replaceFirst("^/home/swg/swg-main/serverdata/clienteffect/", "");
