...
public class tos_bind extends base_script
{
    public int OnAttach(obj_id self)
    {
        setName(self, "Residential Transit Terminal");
    ...
    {
        mi.addRootMenu(menu_info_types.ITEM_USE, new string_id("Depart from Rally Point Nova to Home Bind"));
        return SCRIPT_CONTINUE;
    }
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        if (item == menu_info_types.ITEM_USE)
        {
            ...
            sui.msgbox(self, player, "\\#e3d005Are you sure you want to leave the station and travel home?\\#", sui.OK_CANCEL_ALL, "Transit", "handleBind");
            return SCRIPT_CONTINUE;
        }
        return SCRIPT_CONTINUE;
    }
    ...
    public void sendPlayerToHome(obj_id self, obj_id player) throws InterruptedException
    {
        if (player == null)
        {
            return;
