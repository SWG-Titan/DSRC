...
public class master_controller_krayt extends script.base_script
{
    ...
    public int OnAttach(obj_id self) throws InterruptedException
    {
        ...
        or_player.doWorldBossAnnounce(self, or_player.WORLD_BOSS_KRAYT);
    ...
    public int OnCreatureDamaged(obj_id self, obj_id attacker, obj_id wpn, int[] damage) throws InterruptedException
    {
        ...
        if (percentHealth < 90)
        {
            ...
            {
                obj_id[] aoe_targets = getCreaturesInRange(self, or_player.WORLD_BOSS_CREDIT_RANGE);
        ...
        if (percentHealth < 50)
        {
            if (!utils.hasScriptVar(self, "krayt_adds"))
            {
                ...
                or_player.createCircleSpawn(self, self, "krayt_dragon_adolescent", 6, 12);
