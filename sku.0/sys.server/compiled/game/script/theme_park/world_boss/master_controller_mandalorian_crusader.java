...
public class master_controller_mandalorian_crusader extends script.base_script
{
    ...
    public int OnAttach(obj_id self) throws InterruptedException
    {
        ...
        setDescriptionString(self, "A powerful rogue Mandalorian.");
        ...
        or_player.doWorldBossAnnounce(self, or_player.WORLD_BOSS_PAX);
