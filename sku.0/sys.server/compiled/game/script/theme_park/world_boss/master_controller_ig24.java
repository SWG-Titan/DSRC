...
public class master_controller_ig24 extends script.base_script
{
    ...
    public int OnAttach(obj_id self) throws InterruptedException
    {
        ...
        or_player.doWorldBossAnnounce(self, or_player.WORLD_BOSS_IG24);
    ...
    public int OnCreatureDamaged(obj_id self, obj_id attacker, obj_id wpn, int[] damage) throws InterruptedException
    {
        ...
        if (percentHealth <= 75)
        {
            if (!utils.hasScriptVar(self, "hasSpawned"))
            {
                ...
                or_player.createCircleSpawn(self, self, "world_boss_ig24_add", 2, 5);
