...
public class master_controller_donkdonk_binks extends script.base_script
{
    ...
    public int OnAttach(obj_id self) throws InterruptedException
    {
        ...
        setDescriptionString(self, "A distant cousin to Jar-Jar Binks, this criminal Gungan is notorious for causing havoc in the Chommell Sector");
        ...
        or_player.doWorldBossAnnounce(self, or_player.WORLD_BOSS_DONKDONK);
    ...
    {
        or_player.createCircleSpawn(self, attacker, creatureName, quantity, radi);
