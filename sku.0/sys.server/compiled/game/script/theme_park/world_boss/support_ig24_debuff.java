...
public class support_ig24_debuff extends script.base_script
{
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item) throws InterruptedException
    {
        ...
        {
            obj_id[] possibleIG24 = getAllObjectsWithScript(getLocation(self), or_player.WORLD_BOSS_CREDIT_RANGE, "theme_park.world_boss.master_controller_ig24");
            ...
            for (obj_id potential : possibleIG24)
            {
                if (getTemplateName(potential).endsWith("ig_88_rocket.iff"))
                {
                    ...
                    obj_id[] players = getAllPlayers(getLocation(potential), or_player.WORLD_BOSS_CREDIT_RANGE);
